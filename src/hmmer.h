...
typedef struct p7_pipeline_s {
  ...
  double        exact_gpu_submit_overhead;  /* host submit/pack+enqueue overhead */
  double        exact_gpu_wait_barrier;     /* terminal CUDA wait barrier */
  double        exact_gpu_event_overhead;   /* CUDA event lifecycle overhead */
  ...
  uint64_t      gpu_vit_residues_total;     /* Viterbi GPU candidate residues */
  uint64_t      gpu_fwd_residues_total;     /* Forward GPU candidate residues */
  ...
  double        gpu_vit_avg_residues_per_launch;   /* derived Viterbi residue density */
  double        gpu_fwd_avg_residues_per_launch;   /* derived Forward residue density */
...
extern P7_ALIDISPLAY *p7_alidisplay_Create_nuc(const P7_TRACE *tr, int which, const P7_OPROFILE *om, const ESL_SQ *sq, const struct p7_nucseqview_s *nsv);
...
extern int p7_pli_postFwd_LongTarget(P7_PIPELINE *pli, P7_OPROFILE *om, P7_BG *bg, P7_TOPHITS *hitlist, const P7_SCOREDATA *data,
                                     int64_t seqidx, int window_start, int window_len, ESL_DSQ *subseq,
                                     int64_t seq_start, char *seq_name, char *seq_source, char *seq_acc, char *seq_desc, int seq_len,
                                     int complementarity, int *overlap, P7_PIPELINE_LONGTARGET_OBJS *pli_tmp,
                                     float fwdsc);
extern int p7_pli_postFwdBwd_LongTarget(P7_PIPELINE *pli, P7_OPROFILE *om, P7_BG *bg, P7_TOPHITS *hitlist, const P7_SCOREDATA *data,
                                     ...
                                     int complementarity, int *overlap, P7_PIPELINE_LONGTARGET_OBJS *pli_tmp,
                                     float fwdsc);
extern int p7_pli_postFwdBwdNoF3_LongTarget(P7_PIPELINE *pli, P7_OPROFILE *om, P7_BG *bg, P7_TOPHITS *hitlist, const P7_SCOREDATA *data,
                                     int64_t seqidx, int window_start, int window_len, ESL_DSQ *subseq,
                                     int64_t seq_start, char *seq_name, char *seq_source, char *seq_acc, char *seq_desc, int seq_len,
                                     int complementarity, int *overlap, P7_PIPELINE_LONGTARGET_OBJS *pli_tmp,
                                     float fwdsc);
