...
- External dense-HMM CUDA examples are design references only, not portable kernels. The inspected `divinrkz/cuda-hmm` repository implements dense textbook HMM Viterbi/Forward/Backward, not HMMER Plan7; see `agents_docs/cuda-hmm-migration.md`.
