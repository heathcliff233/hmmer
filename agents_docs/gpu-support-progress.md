...
- **Viterbi boundary**: GPU scanning Viterbi is the CPU-equivalent long-target Viterbi stage. The previous extra single-score GPU Viterbi pre-filter was removed rather than kept as a diagnostic option.
