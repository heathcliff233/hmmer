...
- Domain definition, null2, hit storage, thresholding, and output should stay on CPU for now. Current measurements show null2/output is tiny, and domain work happens after Forward has already reduced the survivor set to a small number of sequences.
